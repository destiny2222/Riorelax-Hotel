    ...
    $(document).ready(function () {
        $("#preloader-active").fadeOut("slow"),
            ...
            $(".main-menu li a").on("click", function () {
                $(window).width() < 700 && $("#mobile-menu").slideUp();
            }),
            $(function () {
            ...
            (function () {
                ...
                e.on("init", function (e, s) {
                    ...
                    e.on("beforeChange", function (e, s, o, i) {
                        t(
                            $(
                                '.single-slider[data-slick-index="' + i + '"]'
                            ).find("[data-animation]")
                        );
                    }),
                    e.slick({
            ...
            $(".count").counterUp({ delay: 100, time: 1e3 }),
            $(".popup-image").magnificPopup({
                type: "image",
                gallery: { enabled: !0 },
            }),
            $(".popup-video").magnificPopup({ type: "iframe" }),
            $(".paroller").length && $(".paroller").paroller(),
            (function () {
                if ($("#parallax").length) {
